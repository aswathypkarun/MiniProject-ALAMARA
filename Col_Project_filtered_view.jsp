...
<html>
    ...
    <center>
        ...
        <%
            ...
            String proj_id="";   
            int project_language=(Integer)session.getAttribute("Project_Language");
            int project_domain=(Integer)session.getAttribute("Project_Type");
            
            String in="select * from tbl_project pr inner join tbl_protype pt on pr.protype_id=pt.protype_id inner join tbl_prolang pl on pr.prolang_id=pl.prolang_id where pr.protype_id='1' and pr.prolang_id='1' and pr.proj_status='1'";
