    ...
    <body>
        ...
        <table border="1">
                ...
                <%
                    ...
                    String ins="select * from tbl_student s inner join tbl_dept d on d.dept_id=s.dept_id inner join tbl_college c on c.col_id=s.col_id where s.dept_id='"+stu_dept+"'";
