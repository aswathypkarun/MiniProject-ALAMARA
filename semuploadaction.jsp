...
<html>
    <head>
        ...
        <title>Alamara | Upload Seminar</title>
    </head>
    <body>
        <%
...
if(isMultipart)
{
   ...
   Iterator itr=items_list.iterator();
    ...
    //Strinh str1="insert into tbl_wantedlist ()";
        ...
        String str1="insert into tbl_seminar (sem_name,sem_descrp,sem_pdf,stu_id,sem_date)values('"+value[0]+"','"+value[1]+"','"+fn+"','"+stu+"',curdate())";
       //out.println(str1);
    ...
    if(status==true)
    {
      ...
      <script type="text/javascript">
            ...
            setTimeout(function(){window.location.href='addseminar.jsp'},100);
        </script>
     <%
    }
     }   
