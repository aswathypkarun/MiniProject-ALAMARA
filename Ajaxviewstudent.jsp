    ...
    <body>
        ...
        <table border="1">
                ...
                <%
                    ...
                    String ins="select * from tbl_student st inner join tbl_college c on st.col_id=c.col_id inner join tbl_collegehead ch on c.col_id=ch.col_id inner join tbl_dept d on st.dept_id=d.dept_id where ch.head_id='"+head+"' and st.dept_id='"+stu_dept+"'";
