...
<%@include file="Viewheader1.jsp" %>
        <title>Alamara | Company - View Project</title>
  ...
  success: function(data) {
    ...
    <center>
        ...
        <div id="colo">
            ...
            <tr>
                <td colspan="2" align="center"><a href="Compprojectprofile.jsp?proj_id=<%=proj_id%>"style="color: red">Click Here for More Details</a></td>
            </tr>
        </table>
                <br><br><br>
        </div>
