...
<% 
    String colname="";
            colname=session.getAttribute("col_name").toString();
%>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="#">View Details</a>
            <ul>
              <li><a href="Colviewproject.jsp">Project</a></li>
              <li><a href="Colviewseminar.jsp">Seminar</a></li>
              <li><a href="viewtech.jsp">Tech Fest</a></li>
              <li><a href="Colviewplacement.jsp">Placement Drives</a></li>
              <li><a href="colviewstudent.jsp">Student</a></li>
              <li><a href="Colviewcompany.jsp">Company</a></li>
              
            </ul>
          </li>
          
          <li class="menu-has-children"><a href="#">Teacher's Registration Status</a>
            <ul>
              <li><a href="addhead.jsp">Pending Requests</a></li>
              <li><a href="viewteacher.jsp">Teacher's List</a></li>
              
              
            </ul>
          </li>
          
          <li class="menu-has-children"><a href="#">Conduct !</a>
            <ul>
              <li><a href="Coladdplacement.jsp">Placement Drives</a></li>
              <li><a href="addtech.jsp">Tech Fest</a></li>
...
%>
 <!-- #header -->
    ...
    <div class="container text-center">
      <div class="row">
          <div class="col-md-12">
              <h1 style="font-size:60px;color:white;text-shadow:3px 3px #007bff; font-weight: bold"><span style="color:white;font-weight: bold">Welcome <a href="myprofile.jsp"> <%=colname%></a></span></h1>
        </div>
      </div>

      <div class="col-md-12">
        <h3>
            Let's Organize Your Alamara
          </h3>
