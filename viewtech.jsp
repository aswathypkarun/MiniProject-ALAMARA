...
//tr:hover {background-color:#f5f5f5;}
    ...
    <body>
        ...
        <table border="1" >
            ...
            <tbody>
                <%
            String sele="select * from tbl_tech t inner join tbl_college c on t.col_id=c.col_id where  curdate() <= t.tech_date ORDER BY tech_date DESC";
