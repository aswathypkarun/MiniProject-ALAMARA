...
function getProject(lid)
{
  ...
  success: function(data) {
         ...
         if(request.getParameter("block")!= null)
            {
                ...
                String bk="update tbl_project set proj_status=2 where proj_id='"+block+"' ";
                boolean boo=con.executeCommand(bk);
                if(boo==true)
                {%>
                    <script>alert("Project Denied");window.location.replace("adviewproject.jsp");</script><%
                }
                else
                {%>
                    <script>alert("Failed Operation");window.location.replace("adviewproject.jsp");</script><%
                }
           }   
        %>
    ...
    <center>
            ...
            Filter By Language : <select name="op" onchange="getProject(this.value)">
        ...
        <div id="colo">
            ...
            <tr>
                <td colspan="2" align="center"><a href="../Admin/Projectprofile.jsp?proj_id=<%=proj_id%>">Click Here for More Details</a></td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    <a href="adviewproject.jsp?block=<%=rs.getString("proj_id")%>">Block Project</a>
                </td>
            </tr>
        </table>
                <br><br><br>
